...
只输出JSON对象：
{"candidates":[{"id":"稳定短ID","premise":"具体但未结算的处境","actors":["主角"],"location":"现实地点","sourceFactIds":["事实ID"],"newFactsRequired":[],"newActorJustification":"","continuationOf":null,"triggerMechanism":"事件如何发生","dramaticQuestion":"本轮需要面对的问题","choices":[{"id":"短ID","action":"具体行为","motivations":[],"barriers":[],"drives":{},"effort":0.5}],"demands":{"exposure":{},"performance":{},"consequence":{}},"difficulty":0.5,"stakes":0.4,"signature":{"actors":[],"setting":"","mechanism":"","issue":""},"processUpdate":null}]}`;
