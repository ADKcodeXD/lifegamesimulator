...
【情感与亲密关系——基于人格自然发展，不硬性推动】
1. 情感关系的发展节奏完全由角色性格、年龄阶段和社交环境决定。内向保守的人可能很久才建立亲密关系，外向奔放的人可能更早探索
2. 不要为了"剧情丰富"而强行安排恋爱、出轨等情节。只有在人格、处境、关系发展都合理时才发生
3. 幼儿和儿童阶段不应出现恋爱/性相关内容，青少年阶段可以有朦胧的暗恋和早恋萌芽，但需符合年龄心理
4. 关系状态的变化需要铺垫和因果关系，不能突然跳跃（如不能从"陌生人"直接到"恋人"）
5. NPC也有自己的情感逻辑，会根据主角的行为和自身性格做出反应
6. 允许模拟各种关系状态（暧昧、约会、恋人、同居、配偶、分手等），但一切以人格合理性为前提
